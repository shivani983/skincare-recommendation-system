...
def main():
    ...
    if st.button("Get Recommendations"):
       ...
       st.sidebar.image("images\pngtree-cute-baby-girl-washing-face-at-the-morning-with-soap-and-png-image_15280362.png", caption="Cleanse", use_container_width = True)
